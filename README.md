# 👩‍💻 Srishti Thakur – Data Analyst Portfolio

Welcome to my GitHub portfolio!
I am a passionate **Data Analyst** with a background in **Commerce and Computer Applications**. I enjoy working with data to uncover insights and create interactive dashboards.

---

## 👩‍🎓 About Me

* 🎓 **B.Com (Hons)** – Finance / Marketing
* 💻 **PGDCA (Post Graduate Diploma in Computer Applications)**
* 📊 Interested in Data Analysis, Visualization & Business Insights
* 🧠 Strong analytical and problem-solving skills
* 🎯 Goal: To build a career in Data Analytics/Business Analystics.
...
GitHub Repository: https://github.com/Srishti-thakur007/Banking_Analytics
